...
| File | Lines | What it is |
| --- | ---: | --- |
| `route.js` | 649 | Admin/moderation backend — no public UI yet (deliberate: the public design is locked; a full admin page can mount on these functions later). |
...
*Generated by `npm run docs:codemap` from main @ 641fcf6 — 332 source files, 61,611 lines. Do not edit this file by hand; edit `docs/code-map-preamble.md` or the source headers.*
