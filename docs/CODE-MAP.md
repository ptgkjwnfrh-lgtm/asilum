...
| `bridges.js` | 642 | ASiLUM brain — THE SIX BRIDGES. Each bridge scores a catalog item for a user from a different angle, then |
...
*Generated by `npm run docs:codemap` from main @ a719c2d — 367 source files, 63,707 lines. Do not edit this file by hand; edit `docs/code-map-preamble.md` or the source headers.*
