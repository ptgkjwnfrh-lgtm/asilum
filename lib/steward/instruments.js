// lib/steward/instruments.js — the eight instruments, run as one movement.
//
...
export const INSTRUMENTS = Object.freeze([
  ...
  // (7 Sep) the feed's chunk laws — lane share, no repeats, full pages, the
  // brand cap, a brand run draining, the anti-monoculture clause, a fresh
  // chunk after the taste moved, cursor size and cost — composed over
  // scrolled sessions on the seed catalog.
  { id: "feed-chunks", script: "scripts/measure-feed-chunks.mjs" },
]);
