...
// ---- Fit profile ------------------------------------------------------------
// Stored only on-device. The stylist may send measurements in an authenticated
// JSON body for transient server-side fit scoring; they are never placed in a
// URL, persisted by the server, or forwarded to an external model.
