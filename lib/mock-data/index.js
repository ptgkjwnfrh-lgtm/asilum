...
export const MOCKS = [
  ...
  { what: "order tracking", where: "lib/social.js trackingFor", note: "orders page states tracking is simulated" },
  { what: "editorial stories", where: "app/hotlist STORIES", note: "original summaries, link out (copyright rule)" },
