...
export const ROOM_MODULES = Object.freeze([
  { id: "statement", title: "STATEMENT", stores: true, note: "your words, sanitized plain text" },
  { id: "soundtrack", title: "ROOM ANTHEM", stores: true, note: "up to three picks from the culture catalog" },
  { id: "top-pieces", title: "TOP PIECES", stores: false, note: "derives live from your favorites and saves" },
  { id: "brands", title: "BRANDS ON RECORD", stores: false, note: "derives live from your followed brands" },
]);
...
export function sanitizeStatement(raw) {
  ...
  if (text.length > STATEMENT_MAX) {
    throw new TypeError(`statement is capped at ${STATEMENT_MAX} characters`);
  }
  return text;
}
