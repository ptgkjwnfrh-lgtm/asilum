...
//
// TODAY'S LIVE SINK: /api/interaction persists bag|share|save|favorite|dwell|
// skip|hide via lib/db recordInteraction and trains the Alpha Learning Bridge.
// The mapping below shows which canonical events already flow through it.
// A future user_events table (supabase/schema-alpha.sql) becomes the durable
// sink; until then buildEvent() is the one shape every producer must emit.
