...
/**
 * Does this piece CREDIT this designer?
 *
 * Credit, not house: a Helmut Lang piece from 1997 credits Helmut Lang, and one
 * from 2015 does not — the label on the garment is the same either way. Reads
 * `item.designers`, never `item.brand`.
 */
...
/** Filter a pool to pieces crediting one designer. A filter, not a score —
 *  see applyOriginConstraint in origin.js. */
