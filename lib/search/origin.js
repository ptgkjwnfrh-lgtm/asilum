...
const ORIGIN_TERMS = Object.assign(Object.create(null), {
  ...
  // 11 Sep 2026: the register grew to the archive canon and these became
  // real bases in it (Situationist is Georgian, Demobaza Bulgarian).
  georgian: ["Georgia"], bulgarian: ["Bulgaria"], vietnamese: ["Vietnam"],
  ukrainian: ["Ukraine"], lebanese: ["Lebanon"], thai: ["Thailand"],
});
