...
export const mem = {
  ...
  merchantConnections: new Map(), // connection uuid -> per-account provider install (v51)
  oauthStates: new Map(), // state hash -> one-use install binding (v51)
  catalogJobs: new Map(), // job uuid -> durable-queue mirror (v51)
  catalogVariants: new Map(), // variant id -> source offer (v51)
  catalogSyncSeen: new Set(), // "run|item" completed-snapshot evidence (v51)
  webhookDeliveries: new Map(), // delivery id -> dedupe row (v51)
  catalogQuarantine: [], // bounded, reason-coded rejected records (v51)
  fashionEntities: new Map(), // stable designer/house identities (v54)
  wikipediaOverviews: new Map(), // "entity|language" -> revision-pinned paragraph (v54)
  fashionDiscoveryEvidence: new Map(), // "entity|source|url" -> qualification evidence (v54)
  fashionRelationships: new Map(), // relationship id -> sourced career edge (v54)
  wikipediaJobs: new Map(), // job key -> leased discovery/refresh work (v54)
  wikipediaAudit: [], // append-only source/update decisions (v54)
  wikipediaReviews: new Map(), // review id -> ambiguous/suspicious candidate (v54)
  engagements: new Set(), // keyed by engKey() below — person-deduped (v28)
  records: new Map(), // "userId|kind|recordId" -> user_records row, camelCase (v53)
  seq: 1,
};
