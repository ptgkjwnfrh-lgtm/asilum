...
/** Which embedding provider and model are configured — `{ name, model }`.
 *  Part of every embedding's identity: a vector is only comparable to another
 *  from the SAME provider and model, which is why it travels with the result. */
