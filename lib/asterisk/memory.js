// lib/asterisk/memory.js — the Asterisk memory READ FACADE (ADR-001, v1).
...
// /api/reset, /api/measurements, /api/follow) — the only write domain owned
// here is section-visibility preferences (asterisk_memory_preferences).
