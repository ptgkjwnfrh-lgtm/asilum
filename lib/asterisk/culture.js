...
export const CULTURE = [
  ...
  { kind: "aesthetic", name: "old money", aliases: ["quiet luxury", "old-money", "stealth wealth"],
    trend: { phase: "classic", note: "still dominant in 2026, though press declares the strict quiet-luxury era maturing toward color", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "gorpcore", aliases: ["gorp", "gorp core", "outdoorcore"],
    trend: { phase: "classic", note: "unavoidable through 2026 — evolving via technical Asian labels", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "mob wife", aliases: ["mob-wife", "mobwife", "mob wife era"],
    trend: { phase: "dated", note: "viral in 2024-25; fashion press calls it dated for 2026", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "opium", aliases: ["opiumcore", "opium style", "vamp", "rage aesthetic"],
    trend: { phase: "peaking", note: "spread from the Atlanta rage scene to mainstream street style", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "office siren", aliases: ["corp-core", "corpcore", "girlboss 2.0", "office core"],
    trend: { phase: "declining", note: "peaked 2024-25; fashion press is moving on for 2026 workwear", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "clean girl", aliases: ["clean girl aesthetic", "vanilla girl"],
    trend: { phase: "peaking", note: "still dominant in 2026 — absorbed quiet-luxury polish into an elevated version", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "pilates princess", aliases: ["princess pilates"],
    trend: { phase: "declining", note: "the curated-wellness ideal is losing ground to gym goblin nonchalance in 2026", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "gym goblin", aliases: ["goblin mode gym"],
    trend: { phase: "rising", note: "2026 counter-trend — comfort over curation, mismatched on purpose", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "boho revival", aliases: ["bold boho", "boho chic", "bohemian", "boho"],
    trend: { phase: "rising", note: "searches up ~30% into 2026 — craft-led, brighter and bolder than the 2010s wave", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "acubi", aliases: ["acubi style", "acubi fashion"],
    trend: { phase: "peaking", note: "Korean minimal wave, early-2020s origin, still strong", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "downtown girl", aliases: ["downtown aesthetic"],
    trend: { phase: "peaking", note: "romanticized city living — steady on TikTok and Pinterest", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "tomato girl", aliases: ["tomato girl summer"],
    trend: { phase: "declining", note: "2023-24 Mediterranean wave — mellowing into general resort dressing", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "eclectic grandpa", aliases: ["grandpacore", "grandpa core"],
    trend: { phase: "peaking", note: "menswear press favorite — idiosyncratic septuagenarian ease", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "whimsigoth", aliases: ["whimsigothic", "whimsy goth"],
    trend: { phase: "peaking", note: "whimsical-mystical-gothic-celestial — steady revival", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "coquette", aliases: ["coquettecore", "dollette"],
    trend: { phase: "peaking", note: "hyperfeminine wave, sibling of balletcore", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "avant basic", aliases: ["avant-basic"],
    trend: { phase: "dated", note: "2021-22 Instagram wave — checkerboard-swirl maximalism reads as its era now", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "archive fashion", aliases: ["archival fashion", "grail hunting", "archive style"],
    trend: { phase: "classic", note: "collector culture — the archive-designer canon and the Antwerp lineage", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "blokecore", aliases: ["bloke core", "football shirt style"],
    trend: { phase: "peaking", note: "matured from thrifted jerseys into collab territory by 2026", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "blokette", aliases: ["blokette core"],
    trend: { phase: "rising", note: "the feminine remix of blokecore — sporty meets coquette", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "coastal cowgirl", aliases: ["beach western"],
    trend: { phase: "declining", note: "recurring summer micro-trend", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "goblincore", aliases: ["goblin core"],
    trend: { phase: "peaking", note: "the feral sibling of cottagecore — moss, mud, decay honored", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "castlecore", aliases: ["castle core", "medievalcore"],
    trend: { phase: "rising", note: "emerging romantic-medieval thread", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "soft girl", aliases: ["soft girl 2.0", "softcore style"],
    trend: { phase: "rising", note: "the 2026 grown-up rework of the original bubblegum version", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "dark feminine", aliases: ["femme fatale", "dark femme"],
    trend: { phase: "peaking", note: "the counter-pole to clean girl — noir seduction", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "brat", aliases: ["brat summer", "brat green"],
    trend: { phase: "dated", note: "the 2024-25 lime moment — its color already shifted to chartreuse for 2026", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "demure", aliases: ["very demure", "very mindful"],
    trend: { phase: "dated", note: "a 2024 micro-moment — kept for search coverage, honestly labeled", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "cyber y2k", aliases: ["cybercore", "y2kcore"],
    trend: { phase: "peaking", note: "the chromed-out futurist branch of the y2k revival", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "that girl", aliases: ["that-girl aesthetic"],
    trend: { phase: "declining", note: "wellness-routine polish — bleeding into clean girl", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "vsco girl", aliases: ["vsco"],
    trend: { phase: "dated", note: "2019 wave — nostalgia territory now", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "hypebeast", aliases: ["hype", "drop culture"],
    trend: { phase: "declining", note: "logo-drop mania cooled as 2010s streetwear matured", lastReviewed: REV },
    interpretations: [
  ...
  { kind: "aesthetic", name: "normcore", aliases: ["norm core"],
    trend: { phase: "classic", note: "the 2014 anti-trend that became a permanent register", lastReviewed: REV },
    interpretations: [
