...
// Asilum seed catalog — 915 listings, stored as JSON (catalog.json) so the
...
/** One seed-catalog item by id, or null. The SEED catalog — demo records that
 *  let the brain run before live ingestion is wired. Never confuse these with
 *  ingested inventory; refusalReason keeps them out of checkout. */
